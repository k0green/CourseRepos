...
Fruit apple = new Fruit("apple", 0.67);
Fruit pear = new Fruit("pear", 2.74);
Fruit banana = new Fruit("banana", 4.09);
Fruit coconut = new Fruit("coconut", 0.99);
Fruit watermelon = new Fruit("watermelon", 1.23);
